    ...
    >
      ...
      >
        ...
        <form
          ...
          className="relative group mb-12 flex flex-col gap-4"
        >
          ...
          <div className="relative flex flex-col gap-2 bg-black/80 rounded-2xl p-2 ring-1 ring-white/10 backdrop-blur-xl shadow-2xl">
            ...
            <div className="flex items-center">
              ...
              <input
                ...
                type="password"
                className="w-full bg-transparent p-4 text-sm font-mono text-white outline-none placeholder:text-white/20"
              />
              <button
                type="submit"
